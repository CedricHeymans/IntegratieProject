sap.ui.define([
	"sap/ui/test/Opa5",
	"IntegratieProject/IntegratieProject/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("IntegratieProject.IntegratieProject.test.integration.arrangements.Startup", {
		...
		iStartMyApp : function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "IntegratieProject.IntegratieProject",
					async: true
				},
				hash: oOptions.hash,
