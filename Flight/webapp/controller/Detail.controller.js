    ...
    return BaseController.extend("be.ap.Flight.controller.Detail", {
        ...
        onPress: function (oEvent) {
            var oFlightSchedule = oEvent.getSource().getBindingContext(),
                sPath = this.getModel().createKey("FlightScheduleSet", {
        ...
        onDateChange: function (oEvent) {
            ...
            aFilters.push(new sap.ui.model.Filter({
                path: "Fldate", // planetype = Planetype
                // @ts-ignore
                operator: "EQ",
                value1: oDate // sPlanetype
            }));
            // filter op los laten
            oBinding.filter(aFilters);
        },

        onPressFlights: function (oEvent) {
